                    ...
                    if(items.size() != 0)
                    {
                        textView.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if(stringBuilder.toString ().toLowerCase ().contains (nomClub) && stringBuilder.toString ().toLowerCase ().contains (nomPresident) && stringBuilder.toString ().contains ("LICENCE")&& stringBuilder.toString ().contains ("Enregistr") && stringBuilder.toString ().contains ("CLUB")){
