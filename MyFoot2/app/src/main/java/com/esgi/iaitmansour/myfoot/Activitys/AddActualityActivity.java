...
public class AddActualityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgActu = findViewById (R.id.imgActuality);


        //********CONFIGURE CLICK PICK IMAGE************//
        ...
        //********CONFIGURE CLICK SEND NEW ACTUALITY************//
        btnSend.setOnClickListener (new View.OnClickListener ( ) {
            @Override
            public void onClick(View view) {


                pd = new ProgressDialog (AddActualityActivity.this);
    ...
    //**************FUNCTION RETURN URI IMAGE PICK********************************////
    @Override
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PICK_IMAGE_FROM_GALLERY_REQUEST) {
            uri = data.getData ( );
            verificationOk = PICK_IMAGE_FROM_GALLERY_REQUEST;
            Picasso.with (AddActualityActivity.this).load (uri).noPlaceholder ( ).centerCrop ( ).fit ( )
                    .into ((ImageView) findViewById (R.id.imgActuality));
    ...
    //**************Request Retrofit Multipart to send actuality
    // ********************************////
