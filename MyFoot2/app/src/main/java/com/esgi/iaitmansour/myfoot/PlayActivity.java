...
public class PlayActivity extends AppCompatActivity {
    ...
    private ArrayList<MatchGame> mMatchGameListComplet = new ArrayList<>();
    ...
    static String apiKey ="WESH MORRAY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent ().hasExtra ("NAME") && getIntent ().hasExtra ("EMAIL") && getIntent ().hasExtra ("PHOTO_URL")&& getIntent ().hasExtra ("nameClub")&& getIntent ().hasExtra ("userId") ){
        ...
        mLogOutButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent (getApplicationContext (), SupporterActivity.class);
                intent.putExtra ("nomClubMorray", nomClub);
                intent.putExtra ("userIdMorray", userId);
